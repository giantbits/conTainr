    ...
    <div class="navbar-inner">
	    <div class="container">
				...
				<div class="btn-group pull-right">
					...
					<?php
						foreach(Yii::app()->urlManager->languages as $clkey => $name)
							echo '<li><a href="'.$this->createUrl('',array('clkey'=>$clkey,'id'=>$model->id,'refkey'=>isset($_GET['refkey'])?$_GET['refkey']:0)).'">'.$name.'</a></li>';
					?>
					</ul>
				</div>
...
<div class="row-fluid">
	<div class="span8">
		...
		<?php echo $form->textAreaRow($model,'teaser',array('class'=>'span12')); ?>
		<?php echo $form->redactorRow($model,'content',array('class'=>'span12','options'=>array('plugins'=>array('containrMedia','containrLink')))); ?>
	</div>

	<div class="span4">
		<div class="well">
			<?php echo $form->checkBoxRow($model,'showHeadline',array('class'=>'')); ?>
			<?php $this->widget('ContainrMediaSelector', array('model'=>$model,'attribute'=>'mediaId','type'=>'image')); ?>
			<?php //echo $form->hiddendRow($model,'mediaId',array('class'=>'span12')); ?>
			<?php echo $form->textFieldRow($model,'mediaPosition',array('class'=>'span12')); ?>
			<?php echo $form->textFieldRow($model,'state',array('class'=>'span12')); ?>
			<?php echo $form->textFieldRow($model,'cssclass',array('class'=>'span12')); ?>
			<?php echo $form->textFieldRow($model,'cssid',array('class'=>'span12')); ?>
			<?php echo $form->dropDownListRow($model,'template',$model->templates, array('class'=>'span12')); ?>
		</div>
	</div>
