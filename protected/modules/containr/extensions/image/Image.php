...
//Yii::import('application.modules.containr.extensions.image.Image_Driver');
...
class Image {
	...
	public function watermark($text,$fontSize,$font = '/themes/holzobjekte/font/verdana.ttf')
	{
	...
	public function addlayer($color,$width,$height) {

		$this->actions['addlayer'] = array
		(
			'color'  => $color,
			'width' => $width,
			'height' => $height
