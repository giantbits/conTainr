  ...
  JqTreeWidget = (function(_super) {
    ...
    JqTreeWidget.prototype._refreshElements = function(from_node) {
      ...
      createNodeLi = function(node) {
        ...
        return $("<li><div class=\"treeaction\"><div class=\"pull-right btn-group btn-mini dropdown\"><button class=\"btn btn-mini edit\" id=\"" + node.id + "\" style=\"z-index: 20;\" ><i class=\"icon icon-pencil\"></i></button><button class=\"btn btn-mini dropdown-toggle\" data-toggle=\"dropdown\"><span class=\"caret\"></span></button><ul class=\"dropdown-menu\"><li><a href=\"#\">Delete</a></li></ul></div><span class=\"title\">" + escaped_name + "</span></div></li>");
      };
      createFolderLi = function(node) {
        ...
        if(node.id == 1)
        	return $("<li class=\"selected " + folder_class + "\"><div class=\"treeaction\"><div class=\"pull-right btn-group dropdown\"><button class=\"btn btn-mini settings\" style=\"z-index: 20; margin-right: 6px;\" id=\"" + node.id + "\"><i class=\"icon-wrench\"></i></button></div><a class=\"" + button_class + "\">&raquo;</a><span class=\"title\">" + escaped_name + "</span></div></li>");
        else
        	return $("<li class=\"" + folder_class + "\"><div class=\"treeaction\"><div class=\"pull-right btn-group btn-mini dropdown\"><button class=\"btn btn-mini edit\" style=\"z-index: 20;\" id=\"" + node.id + "\"><i class=\"icon icon-pencil\"></i></button><button class=\"btn btn-mini dropdown-toggle\" data-toggle=\"dropdown\"><span class=\"caret\"></span></button><ul class=\"dropdown-menu\"><li><a href=\"#\">Delete</a></li></ul></div><a class=\"" + button_class + "\">&raquo;</a><span class=\"title\">" + escaped_name + "</span></div></li>");
      };
