 ...
 */
class ContainrGroupAccessCache extends CActiveRecord
{
	...
	{
		return 'containr_groupaccesscache';
	}
	...
	public function rules()
	{
		...
		// will receive user inputs.
			return array(
				array('type,elementId,usergroup', 'required'),
				array('elementId,usergroup', 'numerical', 'integerOnly'=>true),

				// The following rule is used by search().
				// Please remove those attributes that should not be searched.
//				array('id,nameLast,nameFirst,login,password', 'safe', 'on'=>'search'),
			);
	}
